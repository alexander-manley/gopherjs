...
func (gopherjsToolchain) gc(b *builder, p *Package, archive, obj string, asmhdr bool, importArgs []string, gofiles []string) (ofile string, out []byte, err error) {
	...
	if p.build.IsCommand() && (!p.forceLibrary || p.ImportPath == "testmain") {
		...
		archive, err := BuildPackage(pkg, s, importFromDisk)
		if err != nil {
...
func BuildPackage(pkg *gopherjsbuild.PackageData, s *gopherjsbuild.Session, importLoader func(path string) (*compiler.Archive, error)) (*compiler.Archive, error) {
